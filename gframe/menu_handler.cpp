    ...
    bool MenuHandler::OnEvent(const irr::SEvent &event) {
        ...
        switch (event.EventType) {
            case irr::EET_GUI_EVENT: {
                ...
                if (mainGame->wSC->isVisible() && id != BUTTON_233 && id != BUTTON_23333 && id != BUTTON_7210 &&
                    id != BUTTON_765 && id != BUTTON_222 && id != BUTTON_JP && id != BUTTON_NK && id != BUTTON_SC_EXIT)
                    break;
                if (mainGame->wRM->isVisible() && id != BUTTON_RM_EXIT && id != BUTTON_RM1 && id != BUTTON_RM2 &&
                    id != BUTTON_RM3 && id != BUTTON_RM4 && id != BUTTON_RM5 && id != BUTTON_RM6 && id != BUTTON_RM7 &&
                    id != BUTTON_RM8 && id != BUTTON_RM9 && id != BUTTON_RM10 && id != BUTTON_RM11 &&
                    id != BUTTON_RM12 && id != BUTTON_RM13 && id != BUTTON_RM14 && id != BUTTON_RMCM &&
                    id != BUTTON_RMWN && id != BUTTON_RMAI && id != BUTTON_RMA)
                    break;
                    ...
                    case irr::gui::EGET_BUTTON_CLICKED: {
                        ...
                        switch (id) {
                            ...
                            case BUTTON_HP_READY: {
                                if (mainGame->cbDeckSelect->getSelected() == -1 ||
                                    !deckManager.LoadDeck(
                                            mainGame->cbDeckSelect->getItem(mainGame->cbDeckSelect->getSelected()))) {
                                    break;
                                }
                                UpdateDeck();
                            ...
                            case BUTTON_LOAD_REPLAY: {
                                if (open_file) {
                                    ...
                                    if (mainGame->lstReplayList->getSelected() == -1)
                                        break;
                                    if (!ReplayMode::cur_replay.OpenReplay(mainGame->lstReplayList->getListItem(
                                            mainGame->lstReplayList->getSelected())))
                                        break;
                                }
                            ...
                            case BUTTON_DELETE_REPLAY: {
                                ...
                                myswprintf(textBuffer, L"%ls\n%ls", mainGame->lstReplayList->getListItem(sel),
                                           dataManager.GetSysString(1363));
                            ...
                            case BUTTON_EXPORT_DECK: {
                                ...
                                myswprintf(ex_filename, L"%ls", mainGame->lstReplayList->getListItem(
                                        mainGame->lstReplayList->getSelected()));
                            ...
                            case BUTTON_DECK_EDIT: {
                                ...
                                if (open_file && deckManager.LoadDeck(open_file_name)) {
                                    ...
                                    deckManager.LoadDeck(
                                            mainGame->cbDBDecks->getItem(mainGame->cbDBDecks->getSelected()));
                    ...
                    case irr::gui::EGET_LISTBOX_CHANGED: {
                        switch (id) {
                            case LISTBOX_LAN_HOST: {
                                ...
                                wchar_t buf[20];
                                myswprintf(buf, L"%d.%d.%d.%d", addr & 0xff, (addr >> 8) & 0xff, (addr >> 16) & 0xff,
                                           (addr >> 24) & 0xff);
                                mainGame->ebJoinHost->setText(buf);
                            ...
                            case LISTBOX_REPLAY_LIST: {
                                ...
                                repinfo.append(infobuf);
                                mainGame->ebRepStartTurn->setText(L"1");
                                mainGame->SetStaticText(mainGame->stReplayInfo, 180, mainGame->guiFont,
                                                        repinfo.c_str());
                                break;
                            }
                            case LISTBOX_SINGLEPLAY_LIST: {
                                ...
                                fclose(fp);
                                mainGame->SetStaticText(mainGame->stSinglePlayInfo, 200, mainGame->guiFont,
                                                        message.c_str());
                                break;
                            }
                            case LISTBOX_BOT_LIST: {
                                ...
                                if (sel == -1)
                                    break;
                                mainGame->SetStaticText(mainGame->stBotInfo, 200, mainGame->guiFont,
                                                        mainGame->botInfo[sel].desc);
                                break;
                            }
                        }
                        break;
                        ...
                        switch (id) {
                            case CHECKBOX_HP_READY: {
                                ...
                                if (static_cast<irr::gui::IGUICheckBox *>(caller)->isChecked()) {
                                    if (mainGame->cbDeckSelect->getSelected() == -1 ||
                                        !deckManager.LoadDeck(mainGame->cbDeckSelect->getItem(
                                                mainGame->cbDeckSelect->getSelected()))) {
